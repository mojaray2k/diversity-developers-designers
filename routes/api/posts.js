 ...
 * @method GET
 * @route api/posts/:id
 * @description Fetch all posts by Id
 * @param {function}auth
 * @callback function @param request @param response
 * @access Private
 */
 ...
 * @method PUT
 * @route api/posts/:id
 * @description Update a posts by Id
 * @param {function}auth
 * @callback function @param request @param response
 * @access Private
 */
router.put("/:id", [auth, checkObjectId], async (req, res) => {
  try {
 ...
 * @method DELETE
 * @route api/posts/:id
 * @description Remove a posts by Id
 * @param {function}auth
 * @callback function @param request @param response
 * @access Private
 */
 ...
 * @description Remove a Comment on a Post
 * @param {function}auth
 * @callback function @param request @param response
 * @access Private
 */
